    ...
    <div class="row content" style="margin-top: 5px">
        <div class="col-sm-2 sidenav">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><?php echo anchor(base_url("Status/seat"), 'Seat Plan', array('class' => '', 'title' => 'seat_plan',)); ?></li>
        ...
        <div id="seat" class="container-fluid col-sm-8" style="text-align: center">
            ...
            <a href="<?php echo base_url() . "assets/"; ?>dist/img/2.pdf" download>
                <button class="btn btn-primary" style="margin-top: 45px"> View Seat Plan </button>
            </a>
        </div>
    </div>
</div>
