...
/*        $this->load->view('Layout/content');*/
    ...
    <aside class="control-sidebar control-sidebar-dark">
        ...
        <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
            <li><a href="<?php echo base_url() . "assets/"; ?>#control-sidebar-home-tab" data-toggle="tab"><i
                            class="fa fa-home"></i></a></li>
            <li><a href="<?php echo base_url() . "assets/"; ?>#control-sidebar-settings-tab" data-toggle="tab"><i
